...
tags:
  - docs
description: Some rules & recommendations for creating or adding new blog posts.
---
...
If you want to group posts under `2025`, you can place them in `src/data/blog/2025/`. This also affects the post URL, so `src/data/blog/2025/example-post.md` will be available at `/posts/2025/example-post`.
...
| **unlisted**       | Mark this post 'unlisted'.                                                                                                           | default = false                                |
...
Title and description (excerpt) are important for search engine optimization (SEO) and thus we encourage you to include these in blog posts.
